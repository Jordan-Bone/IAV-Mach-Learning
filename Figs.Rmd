...
ggplot(trat,aes(Transition,ymin=ifelse(mRate-sdRate>0,mRate-sdRate,0), y=mRate, ymax=mRate+sdRate,colour=str_sub(Transition,2,2)))+geom_crossbar()+facet_wrap(~Protein)+theme(legend.position = "none")
